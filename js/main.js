...
function create() {
    ...
    platforms.create(590, 680, 'ground').setScale(2).refreshBody();

   
    platforms.create(750, 500, 'ground');
    platforms.create(80, 380, 'ground');
    platforms.create(750, 220, 'ground');

    platforms.create(600, 800, 'ground');
    platforms.create(200, 800, 'ground');
...
function collectStar (player, star)
{
    ...
    if (stars.countActive(true) === 0)
    {
        ...
        bomb.setVelocity(Phaser.Math.Between(-200, 800), 20);
